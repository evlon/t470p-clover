 ...
 *
 * Disassembly of DSDT.aml, Fri Feb 22 13:33:40 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001FAFC (129788)
 *     Revision         0x02
 *     Checksum         0xDA
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "SKL     "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "SKL     ", 0x00000000)
{
    ...
    External (BNU1, UnknownObj)    // (from opcode)
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0xAB557000, 0x072C)
    ...
    Scope (\_SB.PCI0)
    {
        Device (GLAN)
        {
            ...
            Method (_PRW, 0, NotSerialized){    Return (GPRW (0x6D, 0x04))}
        }
    }
    ...
    Scope (\_SB.PCI0.LPCB)
    {
        ...
        Device (MOU)
        {
            Name (_HID, EisaId ("LEN2045"))  // _HID: Hardware ID
    ...
    OperationRegion (MNVS, SystemMemory, 0xAB568018, 0x1000)
    ...
    Scope (\_SB.PCI0.LPCB.EC)
    {
        ...
        {
            Fatal (0x01, 0x80010000, 0x0001105E)
        }
